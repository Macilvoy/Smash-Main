...
local RPW5 = script:GetCustomProperty("RPW5")
...
elseif math.random(2)==1 then
    ...
    World.SpawnAsset(RPW5,{parent=script.parent,position=Vector3.New(0,0,0),rotation=Rotation.New(0,0,0)})
    trigger:SetNetworkedCustomProperty("ID",5)
end